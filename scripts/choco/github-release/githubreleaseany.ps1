#Thanks to Maximus5 https://raw.githubusercontent.com/Maximus5/Scripts/master/PowerShell/GitHub-Release-Upload/GithubReleaseAny.ps1
...
function UploadAsset([int]$rel_id,[string]$fullpath)
{
  ...
  if ([System.IO.Path]::GetExtension($fname) -eq ".zip") {
